...
<input type="number" class="stealth" name="rounds" id="roundsInput" value="<?php echo $drinkOrDare['total_rounds']; ?>" style="float: right; width: 60px; text-align: right;" readonly />
<div class="clear"></div>
...
<input type="number" class="stealth" name="drinks_to_win" id="drinksToWinInput" value="<?php echo $drinkOrDare['drinks_to_win']; ?>" style="float: right; width: 60px; text-align: right;" readonly />
<div class="clear"></div>
